...
const team_members_js_1 = require("./routes/team_members.js");
const rfis_js_1 = require("./routes/rfis.js");
const drawings_js_1 = require("./routes/drawings.js");
const invoices_js_1 = require("./routes/invoices.js");
const submittals_js_1 = require("./routes/submittals.js");
const risk_dashboard_js_1 = require("./routes/risk_dashboard.js");
...
app.use('/api/team-members', team_members_js_1.teamMembersRouter);
app.use('/api/rfis', rfis_js_1.rfisRouter);
app.use('/api/drawings', drawings_js_1.drawingsRouter);
app.use('/api/invoices', invoices_js_1.invoicesRouter);
app.use('/api/submittals', submittals_js_1.submittalsRouter);
app.use('/api/risk-dashboard', risk_dashboard_js_1.riskDashboardRouter);
